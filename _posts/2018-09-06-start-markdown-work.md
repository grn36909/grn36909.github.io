---
layout: post
title:  "jekyll简易教程 -- 3.Markdown 指南"
date:   2019-09-06 10:29 UTC+8
categories: jekyll markdown
permalink: /archivers/jekyll/learn03
---

![markdown]({{ site.url }}/assets/2018-09-06-start-markdown-work/markdown2.jpg)

# jekyll简易教程 -- 3.Markdown 指南

[原文作者-younghz](https://github.com/younghz/Markdown#二级标题)  
...
![Aaron Swartz]({{ site.url }}/assets/2018-09-06-start-markdown-work/Aaron_Swartz.jpg)
...
![markdown]({{ site.url }}/assets/2018-09-06-start-markdown-work/markdown3.jpg)
...
使用 \'\'\' 可以快速指定代码区块，并指定代码语言。  
指定区块语言：  

\```pyhton  
for i in range(1, 5):  
    print('hello world! $s' % you_name)  
\```  
